...
# Periksa panjang kunci tidak nol dan hanya terdiri dari huruf abjad kecil
if not kunci.isalpha() or len(kunci) == 0:
    print("Kunci tidak valid. Harap masukkan kunci yang valid.")
    exit()
...
while True:
    ...
    if choice == "1":
        ...
        hasil_enkripsi = polyalphabet_cipher_encrypt(plainteks, key)
